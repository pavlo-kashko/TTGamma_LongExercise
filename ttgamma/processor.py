...
def selectPhotons(photons):
    ...
    tightPhotons = photons[(photonSelect) & (photons.cutBased >= 3)]  # FIXME 1a
...
class TTGammaProcessor(processor.ProcessorABC):
    ...
    def process_shift(self, events, shift_syst=None):
        ...
        if self.isMC:
            ...
            weights.add("eleEffWeight", 
                        weight=eleSF,
                        weightUp=eleSF_up,
                        weightDown=eleSF_down,
            )  # FIXME 4
            ...
            weights.add("muEffWeight", 
                        weight=muSF,
                        weightUp=muSF_up,
                        weightDown=muSF_down,
            )  # FIXME 4
